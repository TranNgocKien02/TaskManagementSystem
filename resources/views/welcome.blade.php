...
<!-- Mirrored from admin.pixelstrap.net/zono/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Mar 2025 13:26:49 GMT -->
<head>
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"> <img class="img-fluid for-light" src="{{ asset('assets/images/logo/logo.png')}}" alt="logo"><img class="img-fluid for-dark" src="{{ asset('assets/images/logo/logo_dark.png')}}" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-50" src="{{ asset('assets/images/ecommerce/05.jpg')}} alt="">
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-50" src="{{ asset('assets/images/ecommerce/02.jpg')}} alt="">
                  ...
                  <div class="card-body premium-card">
                    <div class="row premium-courses-card">
                      ...
                      <div class="col-md-7 premium-course-img"> 
                        <div class="premium-message"><img class="img-fluid" src="{{ asset('assets/images/dashboard/massage.gif')}}" ></div>
                        <div class="premium-books"><img class="img-fluid" src="{{ asset('assets/images/dashboard/books.gif')}} "></div>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <table class="last-orders-table table" id="last-orders">
                        ...
                        <tbody>
                          <tr> 
                            <td>
                              <div class="user-data">
                                <div><img src="{{ asset('assets/images/dashboard/avtar/2.jpg')}} alt="avatar"></div>
                          ...
                          <tr>
                            <td>
                              <div class="user-data">
                                <div><img src="{{ asset('assets/images/dashboard/avtar/17.jpg')}} alt="avatar"></div>
                                <div><a href="user-profile.html">
                          ...
                          <tr>
                            <td>
                              <div class="user-data">
                                <div><img src="{{ asset('assets/images/dashboard/avtar/19.jpg')}} alt="avatar"></div>
                                <div><a href="user-profile.html">
                  ...
                  <div class="card-body pt-0">
                    <div class="notification-card">
                      <ul>
                        ...
                        <li> 
                          <div class="user-notification">
                            <div> <img src="{{ asset('assets/images/dashboard/avtar/18.jpg')}} alt="avatar"></div>
                            <div class="user-description"><a href="letter-box.html">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="team-avtar">
                              <div class="customers d-inline-block avatar-group">
                                <ul>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/8.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/10.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/2.jpg')}} alt=""></li>
                          ...
                          <tr>
                            ...
                            <td class="team-avtar">
                              <div class="customers d-inline-block avatar-group">
                                <ul>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/2.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/20.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/12.jpg')}} alt=""></li>
                                  <li class="d-inline-block">
                                    <p>6+</p>
                                  </li>
                                </ul>
                          ...
                          <tr>
                            ...
                            <td class="team-avtar"> 
                              <div class="customers d-inline-block avatar-group">
                                <ul>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/14.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/13.jpg')}} alt=""></li>
                                </ul>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="team-avtar">
                              <div class="customers d-inline-block avatar-group">
                                <ul> 
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/22.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/15.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/2.jpg')}} alt=""></li>
                                </ul>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="team-avtar">
                              <div class="customers d-inline-block avatar-group">
                                <ul>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/21.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/23.jpg')}} alt=""></li>
                                  <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{ asset('assets/images/dashboard/avtar/24.jpg')}} alt=""></li>
                                  <li class="d-inline-block"> 
                                    <p>5+                           </p>
                                  </li>
                                </ul>
...
<!-- Mirrored from admin.pixelstrap.net/zono/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Mar 2025 13:26:58 GMT -->
</html>